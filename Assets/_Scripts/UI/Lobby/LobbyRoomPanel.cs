...
public class LobbyRoomPanel : MonoBehaviour {
    ...
    public void UpdateDetails(Lobby lobby) {
        ...
        // _typeText.text = LobbyConstants.GameTypes[GetValue(LobbyConstants.GameTypeKey)];

        // var point = Mathf.InverseLerp(0, LobbyConstants.Difficulties.Count - 1, GetValue(LobbyConstants.DifficultyKey));
